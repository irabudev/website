                ...
                <div class="col-lg-6 col-md-6">
                    <div class="infotechno-hero-inner-images">
                        <div class="infotechno-inner-one">
                            <img class="img-fluid"
                                src="{{ asset('images/hero/home-infotechno-main-slider-slide-01-image-01.png') }}"
                                alt="">
                        </div>
                        <div class="infotechno-inner-two  wow move-up">
                            <img class="img-fluid"
                                src="{{ asset('images/hero/home-infotechno-main-slider-slide-01-image-02.png') }}"
                                alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 ">
                    <div class="tab-history-image video-popup mt-30">
                        ...
                        <div class="single-popup-wrap">
                            <img class="img-fluid"
                                src="{{ asset('images/bg/home-processing-video-intro-slider-slide-01-image-01-570x350.jpg') }}"
                                alt="">
                ...
                <div class="col-lg-5 offset-lg-1 ">
                    <div class="tab-content-inner  mt-30">
                        <div class="text mb-30">
                            One of our proud product is gorocket.co. Gorocket is a simple, instinctive and customizable
                            cloud based tool that helps you manage your leads, sales and product delivery processes;
                            ultimately boosting sales and productivity!
                        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="cta-button-group--one text-center">
                        <a href="element-cta.html#" class="btn btn--white btn-one"><span class="btn-icon mr-2"><i
                                    class="far fa-comment-alt-dots"></i></span> Let's talk</a>
                        <a href="element-cta.html#" class="btn btn--secondary  btn-two"><span class="btn-icon mr-2"><i
                        ...
                        <div class="swiper-container brand-logo-slider__container">
                            <div class="swiper-wrapper brand-logo-slider__one">
                                <div class="swiper-slide brand-logo brand-logo--slider">
                                    <a href="element-client-logo.html#">
                                        <div class="brand-logo__image">
                                            <img src="{{ asset('images/brand/mitech-client-logo-01.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                ...
                                <div class="swiper-slide brand-logo brand-logo--slider">
                                    <a href="element-client-logo.html#">
                                        <div class="brand-logo__image">
                                            <img src="{{ asset('images/brand/mitech-client-logo-02.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                        <div class="brand-logo__image-hover">
                                ...
                                <div class="swiper-slide brand-logo brand-logo--slider">
                                    <a href="element-client-logo.html#">
                                        <div class="brand-logo__image">
                                            <img src="{{ asset('images/brand/mitech-client-logo-03.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                        <div class="brand-logo__image-hover">
                                ...
                                <div class="swiper-slide brand-logo brand-logo--slider">
                                    <a href="element-client-logo.html#">
                                        <div class="brand-logo__image">
                                            <img src="{{ asset('images/brand/mitech-client-logo-04.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                        <div class="brand-logo__image-hover">
                                ...
                                <div class="swiper-slide brand-logo brand-logo--slider">
                                    <a href="element-client-logo.html#">
                                        <div class="brand-logo__image">
                                            <img src="{{ asset('images/brand/mitech-client-logo-05.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                        <div class="brand-logo__image-hover">
                                ...
                                <div class="swiper-slide brand-logo brand-logo--slider">
                                    <a href="element-client-logo.html#">
                                        <div class="brand-logo__image">
                                            <img src="{{ asset('images/brand/mitech-client-logo-06.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                        <div class="brand-logo__image-hover">
                                ...
                                <div class="swiper-slide brand-logo brand-logo--slider">
                                    <a href="element-client-logo.html#">
                                        <div class="brand-logo__image">
                                            <img src="{{ asset('images/brand/mitech-client-logo-07.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                        <div class="brand-logo__image-hover">
                                ...
                                <div class="swiper-slide brand-logo brand-logo--slider">
                                    <a href="element-client-logo.html#">
                                        <div class="brand-logo__image">
                                            <img src="{{ asset('images/brand/mitech-client-logo-08.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                        <div class="brand-logo__image-hover">
                                ...
                                <div class="swiper-slide brand-logo brand-logo--slider">
                                    <a href="element-client-logo.html#">
                                        <div class="brand-logo__image">
                                            <img src="{{ asset('images/brand/mitech-client-logo-09.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                        <div class="brand-logo__image-hover">
