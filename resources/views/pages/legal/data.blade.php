                ...
                <div class="markup markup-titles counters markup-lists links-underline links-blue">
                    <p>
                        This addendum is part of the <a href="{{ route('legal.conditions') }}">General Terms and
                            Conditions</a> between Irabu Systems Ltd and the customer (hereinafter referred to as:
                        "<strong>Controller</strong>") with respect to the processing of Personal Data. By agreeing with
                        the terms and conditions, of which this addendum is a part, the customer also agrees with the
                        below listed provisions with regard to the processing of Personal Data by Irabu Systems Ltd.
                    </p>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>The Controller must keep a register of the processing activities that take place under his
                            responsibility in accordance with article 30 (1) of the GDPR.</li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            ...
                            court is the court of the judicial district of Tanzania, being the district in which the
